      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3">
        {penTask?.map((task, idx) => {
          return (
            <div
              key={idx}
              className="card bg-purple-400 text-black  rounded-lg"
            >
              <div className="card-body p-5">
                ...
                <div className="card-actions justify-center">
                  ...
                  >
                    ...
                    <span className="font-lg font-bold relative transition-colors duration-300 delay-200 group-hover:text-white ease">
                      Wanna Submit?
                    </span>
                  </Link>
                </div>
