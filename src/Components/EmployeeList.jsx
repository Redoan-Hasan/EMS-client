    ...
    useEffect(() => {
        axios.get("http://localhost:5000/addEmployee").then((res) => {
    ...
    useEffect(() => {
        axios
        .get("http://localhost:5000/allPendingTasks")
        .then((res) => {
            console.log(res.data);
    ...
    useEffect(() => {
        axios
        .get("http://localhost:5000/allCompletedTask")
        .then((res) => {
            console.log(res.data);
            ...
            <table className="table w-fit ">
                ...
                {pendingTasks?.map((task, idx) => {
                    ...
                    <tr key={idx} className="">
                        ...
                        <td>{task?.email.slice(0, task?.email.indexOf("@")).toUpperCase()}</td>
                    </tr>
                    );
                })}
                </tbody>
