    ...
    <div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3">
        {completedTasks?.map((task, idx) => {
          return (
            <div key={idx} className="card bg-blue-400 text-black  rounded-lg">
              <div className="card-body p-5">
                ...
                <p className="text-lg font-semibold text-black">
                  <span className="text-red-600">Task Category :</span>{" "}
                  {task.category}
                </p>
                <p className="text-lg font-semibold text-black">
                  <span className="text-red-600">Task Priority :</span>{" "}
                  {task.priority}
                </p>
                <p className="text-lg font-semibold text-black">
                  <span className="text-red-600">Task Date :</span> {task.date}
                </p>
                <p className="text-lg font-medium ">
                  <span className="text-red-600">Task Description :</span> :{" "}
                  {task.description}
                </p>
