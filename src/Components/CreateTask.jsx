...
const CreateTask = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("https://ems-server-eight.vercel.app/addTask", newTask)
      .then((res) => {
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-control py-2">
            ...
            <div className="text-lg font-semibold flex justify-start items-center gap-3">
              <input type="radio" name="priority" id="" value="High" required />
              <span>High</span>
              <input type="radio" name="priority" id="" value="low" required />
              <span>Low</span>
            </div>
          </div>
          <div className="form-control py-2 font-raleway">
